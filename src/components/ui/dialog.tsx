    ...
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          "w-full max-h-[100dvh] overflow-y-auto",
          "inset-0 rounded-none p-4 sm:inset-auto sm:top-[50%] sm:left-[50%] sm:translate-x-[-50%] sm:translate-y-[-50%] sm:max-w-lg sm:max-h-[85vh] sm:rounded-lg sm:p-6",
          className
        )}
        {...props}
      >
